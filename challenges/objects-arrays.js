...
console.log(`The tyrannosaurs weighed about ${dinosaurs.weight}.`);

// What was the diet of a velociraptor?
console.log(`The velociraptor's diet was ${dinosaurs3.diet}.`);

// How long was a stegosaurus?
console.log(`The stegosaurs' length was ${dinosaurs2.length}.`);

// What time period did tyrannosaurus live in?
console.log(
  `The time period that the tyrannosaurus lived in was the ${dinosaurs.period}.`
);
...
*/
const displayNames = zooAnimals.map(function(animal) {
...
*/
const lowPopulationAnimals = zooAnimals.filter(value => zooAnimals.value > 5);
